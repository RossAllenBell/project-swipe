...
public class Background : MonoBehaviour
{
    ...
    public static void Reposition ()
    {
        ...
        trees.transform.position = new Vector2 (Main.BoardWidth, Main.VisibleBoardHeight - (trees.GetComponent<SpriteRenderer>().bounds.size.y / 2));
        //place the ground so that it covers about 75% of the board
        ground.transform.position = new Vector2 (Main.BoardWidth, (Main.VisibleBoardHeight * 0.75f) - (ground.GetComponent<SpriteRenderer>().bounds.size.y / 2));
